...
public sealed class GetTransfers : IRpcMethod<GetTransfers, GetTransfersParameters, GetTransfersResult>
{
    ...
    public sealed record GetTransfersResult
    {
        ...
        public sealed record Transfer
        {
            ...
            public required Index SubaddressIndex { get; set; }

            [JsonPropertyName("subaddr_indices")]
            public required Index[] SubaddressIndicies { get; set; }
...
public sealed partial class WalletRpcClient : IRpcMethodImpl<GetTransfers, GetTransfersParameters, GetTransfersResult>
{
